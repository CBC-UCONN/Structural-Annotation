...
BUSCODIR=../../results/busco/braker_tsebra
mkdir -p ${BUSCODIR}
cd ${BUSCODIR}
...
# predicted proteins
ALLPROT=../../../results/gFACs/braker_tsebra/all/genes.fasta.faa
MONOPROT=../../../results/gFACs/braker_tsebra/monoexonics/genes.fasta.faa
MULTIPROT=../../../results/gFACs/braker_tsebra/multiexonics/genes.fasta.faa
