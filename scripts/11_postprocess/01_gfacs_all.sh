...
OUTALL=${GFACS}/braker_tsebra/all
mkdir -p ${OUTALL}

OUTMONO=${GFACS}/braker_tsebra/monoexonics
mkdir -p ${OUTMONO}

OUTMULTI=${GFACS}/braker_tsebra/multiexonics
mkdir -p ${OUTMULTI}
...
# gff annotation
ANNOTATION=../../results/braker/tsebra/tsebra_combined.gtf
