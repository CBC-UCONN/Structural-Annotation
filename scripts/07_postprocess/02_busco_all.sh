...
# predicted proteins
ALLPROT=../../../results/gFACs/braker_rna/all/genes.fasta.faa
MONOPROT=../../../results/gFACs/braker_rna/monoexonics/genes.fasta.faa
MULTIPROT=../../../results/gFACs/braker_rna/multiexonics/genes.fasta.faa
