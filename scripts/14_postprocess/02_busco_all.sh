...
BUSCODIR=../../results/busco/braker_longreads
mkdir -p ${BUSCODIR}
cd ${BUSCODIR}
...
# predicted proteins
ALLPROT=../../../results/gFACs/braker_longreads/all/genes.fasta.faa
MONOPROT=../../../results/gFACs/braker_longreads/monoexonics/genes.fasta.faa
MULTIPROT=../../../results/gFACs/braker_longreads/multiexonics/genes.fasta.faa
