...
OUTALL=${GFACS}/braker_longreads/all
mkdir -p ${OUTALL}

OUTMONO=${GFACS}/braker_longreads/monoexonics
mkdir -p ${OUTMONO}

OUTMULTI=${GFACS}/braker_longreads/multiexonics
mkdir -p ${OUTMULTI}
...
# gff annotation
ANNOTATION=../../results/braker/longreads/braker/augustus.hints.gtf
